...
int main(int argc, char *argv[]) {
  ...
  float suma11 = 0.0, suma12 = 0.0, suma13 = 0.0, suma14 = 0.0, suma15 = 0.0,
        suma16 = 0.0, suma17 = 0.0, suma18 = 0.0;
  ...
  if ((ttime) > 0.0) {
    printf("GFlop = %10.3lf, Secs = %10.3lf, GFlop per sec = %10.3lf (GFLOPs), "
           ...
           suma11 + suma12 + suma13 + suma14 + suma15 + suma16 + suma17 +
               suma18);
  }
